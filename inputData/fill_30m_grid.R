...
for(i in 1:10) {
  ...
  adm_list <- cbind.data.frame(grid_list, province_list, commune_list)
  adm_list <- adm_list[, c(1, 3:4)]
  names(adm_list) <- c("cell_id", "prov_id", "comm_id")
