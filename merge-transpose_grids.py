...
# my_dir = "C:/Users/cbaehr/Downloads"
my_dir = '/sciclone/home20/cbaehr/cambodia_gie'
...
for i in range(1, 26):
	test = pd.read_csv(my_dir+'/province_pre_panels/pre_panel'+str(i)+'.csv')
...
for i in range(1, 26):
	with open(my_dir+'/province_pre_panels/pre_panel'+str(i)+'.csv') as f, open(my_dir+'/province_panels/panel'+str(i)+'.csv', 'w') as f2:
